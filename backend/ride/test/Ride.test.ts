...
test('Deve fazer o cálculo do preço de uma corrida durante o dia', () => {
  const ride = new Ride()
  ride.addSegment(10, new Date('2021-03-01T10:00:00'))
  expect(ride.calculate()).toBe(21)
})

test('Deve fazer o cálculo do preço de uma corrida durante a noite', () => {
  const ride = new Ride()
  ride.addSegment(10, new Date('2021-03-01T23:00:00'))
  expect(ride.calculate()).toBe(39)
})

test('Deve fazer o cálculo do preço de uma corrida no domingo de dia', () => {
  const ride = new Ride()
  ride.addSegment(10, new Date('2021-03-07T10:00:00'))
  expect(ride.calculate()).toBe(29)
})

test('Deve fazer o cálculo do preço de uma corrida no domingo de noite', () => {
  const ride = new Ride()
...
test('Deve fazer o cálculo do preço de uma corrida durante o dia com preço mínimo', () => {
  const ride = new Ride()
  ride.addSegment(3, new Date('2021-03-01T10:00:00'))
  expect(ride.calculate()).toBe(10)
})

test('Deve fazer o cálculo do preço de uma corrida com múltiplos segmentos', () => {
  const ride = new Ride()
  ride.addSegment(10, new Date('2021-03-01T10:00:00'))
  ride.addSegment(10, new Date('2021-03-01T10:00:00'))
